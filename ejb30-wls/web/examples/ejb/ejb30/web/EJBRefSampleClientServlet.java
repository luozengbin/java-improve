...
import examples.ejb.ejb30.ejbref.Process;
...
/**
 * This is the client view of EJB Reference sample.
 */
public class EJBRefSampleClientServlet extends HttpServlet {
  ...
  private void printPageHeader(HttpServletRequest request, HttpServletResponse response, PrintWriter out) {
    ...
    String tips = "This example demostrates the usage of EJB reference in Session Bean and Servlet.<p>" +
        "The <a href='" + Constants.JAVA_SOURCE_BASE_DIR + "/web/EJBRefSampleClientServlet.html'>EJBRefSampleClientServlet</a> " +
        "references a simple stateless session bean <a href='" + Constants.JAVA_SOURCE_BASE_DIR + "/ejbref/ProcessBean.html'>ProcessBean</a>" +
        " which further references another session bean ReviewerListenerBean <a href='" + Constants.JAVA_SOURCE_BASE_DIR + "/mdb/ReviewerListenerBean.html'><a/><p>" +
        "The ProcessBean will select a book for the guest reviewer to add comments randomly. " +
        "When new comments are added, ReviewerListenerBean is called by the ProcessBean to " +
        "notify the subscribers of the selected book." +
        "<HR>";
    out.println(tips);
  }
  ...
  private void printErrorMsgs(PrintWriter out, Exception ex) {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (errorMsg == null) {
      ...
      out.println("<p align='center'>Your comments has been saved. Please review another randomly selected book.</p>");
    } else
